...
Your job is to:
1. Extract the objective SPY and SPX gamma levels.
2. Read the Founder’s Note / SG Summary / macro comments.
3. Understand the market regime for TODAY.
4. Interpret how the alerts change the meaning of the gamma levels.
